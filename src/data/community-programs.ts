...
export const communityPrograms: CommunityProgram[] = [
	{
		...
		role: 'Co-producer',
		organization: 'Out in Tech NYC × The Generations Project',
		date: '2025–2026',
		year: 2026,
		location: 'New York',
		status: 'current',
	...
	},
	{
		...
		role: 'Instructor, choreographer, and rehearsal lead',
	...
	{
		id: 'focus-and-flow',
		title: 'Focus & Flow: Strategies for Queer Tech Professionals',
		category: 'community-programming',
